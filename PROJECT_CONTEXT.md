...
- RO Billing analysis cache namespace is `kia:business-excellence:ro-billing:v17`. On 01 Jun 2026 the Business Excellence Redis keys were cleared so the next dashboard load fetches fresh Supabase data; the cache system remains enabled and will repopulate after the fresh responses.
