...
export const GATE_PASS_PURPOSES = [
  ...
  'CSD visit',
  'Customer vehicle pickup/drop',
  'Demo vehicle delivery to customer',
  'Fuel filling',
  'Home test drive with customer',
  'Official work',
  'Parts delivery (Mobis/spares)',
  'Sales event or rally',
  'Showroom visit',
  'Stockyard visit',
  'Test drive with customer',
  'Video shoot',
  'Warranty parts packing',
  'Workshop visit',
  'REQUIRED BY SANJAY SIR',
  'REQUIRED BY TARUN SIR',
  'REQUIRED BY ANKUR SIR',
  'REQUIRED BY ARYAN SIR',
  'Bank Visit for Payment',
  'Stock Yard Washing',
  'event',
  'rso visit',
  'offical visit',
  'test',
  'customer home visit',
  'Transfer to Jammu from Lamberi',
  'NEW CAR DELIVERY',
  'Internal Use',
  'Service/Maintenance',
