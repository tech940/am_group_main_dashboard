...
// v16 delegation_tasks, v17 kia.approvals, v18 scrap_erp & kia.booking_payment_history, v19 ccm lead_followups) — cached snapshots are keyed on this, so without a bump an
// existing session would carry stale permissions for up to the cache TTL.
const PERMISSION_CACHE_VERSION = 'v19'
