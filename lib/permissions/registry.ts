...
export const PERMISSION_GROUPS: PermissionGroupDefinition[] = [
  ...
  {
    key: 'mg.business_excellence.ro_billing',
    name: 'RO Billing',
    parentKey: 'mg.business_excellence',
    description: 'AM MG RO Billing report and analysis.',
    sortOrder: 162,
    actions: ['view'],
  },
  {
    key: 'mg.business_excellence.workshop_performance',
    name: 'Workshop Performance',
    parentKey: 'mg.business_excellence',
    description: 'AM MG workshop performance analytics.',
    sortOrder: 163,
    actions: ['view'],
  },
  {
    key: 'mg.business_excellence.open_ro',
    name: 'Open RO',
    parentKey: 'mg.business_excellence',
    description: 'AM MG open repair order tracking.',
    sortOrder: 164,
    actions: ['view'],
  },
  {
    key: 'mg.business_excellence.complaints',
    name: 'Complaints',
    parentKey: 'mg.business_excellence',
    description: 'AM MG complaint tracking and follow-up.',
    sortOrder: 165,
    actions: ['view'],
  },
  {
    key: 'mg.business_excellence.rsa',
    name: 'RSA',
    parentKey: 'mg.business_excellence',
    description: 'AM MG roadside assistance reporting.',
    sortOrder: 166,
    actions: ['view'],
  },
  {
    key: 'mg.business_excellence.ew',
    name: 'Extended Warranty',
    parentKey: 'mg.business_excellence',
    description: 'AM MG extended warranty reporting.',
    sortOrder: 167,
    actions: ['view'],
  },
  {
    key: 'mg.business_excellence.mcp',
    name: 'MCP',
    parentKey: 'mg.business_excellence',
    description: 'AM MG MCP reporting.',
    sortOrder: 168,
    actions: ['view'],
  },
  {
    ...
    name: 'Demo Job Cards',
    parentKey: 'mg.service',
    description: 'AM MG demo job card tracking.',
    sortOrder: 169,
    actions: ['view', 'edit'],
  },
  {
  ...
  },
  {
    ...
    name: 'Demo Cars List',
    parentKey: 'mg.service',
    description: 'AM MG demo cars list and vehicle remarks.',
    sortOrder: 171,
    actions: ['view', 'edit'],
  },
  {
...
export const ROLE_PERMISSION_TEMPLATES: Record<PermissionRole, string[]> = {
  ...
  manager: [
    ...
    ...keysForGroups(['mg', 'mg.service', 'mg.business_excellence', 'mg.demo_job_cards', 'mg.service_appointment', 'mg.demo_cars_list', 'mg.proforma'], ['view', 'approve']),
    ...keysForGroups(['am_finance'], ['view']),
  ],
  technician: [
    ...keysForGroups(['kia.service', 'kia.demo_job_cards', 'kia.service_appointment', 'kia.demo_cars_list', 'kia.proforma'], ['view', 'create', 'edit']),
    ...keysForGroups(['mg.service', 'mg.demo_job_cards', 'mg.service_appointment', 'mg.demo_cars_list', 'mg.proforma'], ['view', 'create', 'edit']),
    ...keysForGroups(['am_finance'], ['view']),
  ],
  viewer: [
    ...keysForGroups(['kia.service', 'kia.service_appointment', 'kia.demo_cars_list', 'kia.proforma'], ['view', 'create', 'edit']),
    ...keysForGroups(['mg.service', 'mg.service_appointment', 'mg.demo_cars_list', 'mg.proforma'], ['view', 'create', 'edit']),
    ...keysForGroups(['am_finance'], ['view']),
  ],
}
