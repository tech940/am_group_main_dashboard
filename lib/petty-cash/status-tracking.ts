...
const STAGE_INFO: Record<string, PettyCashStageInfo> = {
  ...
  gsm_pending: { stageLabel: 'CEO Approval', pillLabel: 'Waiting on CEO', approver: 'CEO', state: 'pending', tone: 'amber' },
  gsm_on_hold: { stageLabel: 'CEO Approval · On Hold', pillLabel: 'On hold — CEO', approver: 'CEO', state: 'pending', tone: 'sky' },
  gsm_approved: { stageLabel: 'EA Approval', pillLabel: 'Waiting on EA', approver: 'EA', state: 'pending', tone: 'amber' },
  gsm_rejected: { stageLabel: 'Rejected by CEO', pillLabel: 'Rejected by CEO', approver: null, state: 'terminal', tone: 'rose' },
  ceo_pending: { stageLabel: 'CEO Approval', pillLabel: 'Waiting on CEO', approver: 'CEO', state: 'pending', tone: 'amber' },
  ceo_on_hold: { stageLabel: 'CEO Approval · On Hold', pillLabel: 'On hold — CEO', approver: 'CEO', state: 'pending', tone: 'sky' },
  ceo_approved: { stageLabel: 'EA Approval', pillLabel: 'Waiting on EA', approver: 'EA', state: 'pending', tone: 'amber' },
  ceo_rejected: { stageLabel: 'Rejected by CEO', pillLabel: 'Rejected by CEO', approver: null, state: 'terminal', tone: 'rose' },
