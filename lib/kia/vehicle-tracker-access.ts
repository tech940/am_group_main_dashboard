...
//
// - Fill (log out / mark returned): MD & Developer.
// - View: General Service Manager (+ MD & Developer).
// - Branch Admin is intentionally EXCLUDED — they are Petty-Cash-only, and the tracker living under
//   "AM Kia" was the sole reason that brand appeared for them.
// - General Sales Manager (`general_manager`) is intentionally excluded — service only.

export const VEHICLE_TRACKER_VIEW_ROLES = ['developer', 'md', 'service_general_manager'] as const
export const VEHICLE_TRACKER_FILL_ROLES = ['developer', 'md'] as const
