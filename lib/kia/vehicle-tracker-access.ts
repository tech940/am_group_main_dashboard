...
// exclude the Sales General Manager. These roles are the single source of truth and
...
// - View: Branch Admin + Service General Manager (+ MD & Developer).
// - Sales General Manager (`general_manager`) is intentionally excluded — service only.
