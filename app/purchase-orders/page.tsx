...
function PurchaseOrdersPageContent() {
  ...
  // CA / MD / Developer get a "CA" section as a TAB inside Purchase Orders (hardcoded — not the tier/
  // permission system; see lib/permissions/legacy-module-roles.ts). Petty-cash approvals are NOT here;
