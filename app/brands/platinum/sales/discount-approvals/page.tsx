...
import { DiscountApprovalsDashboardClient } from '../../../hyundai/sales/discount-approvals/discount-approvals-client'

export default async function PlatinumDiscountApprovalsDashboardPage() {
