...
type PlatinumModuleDefinition = {
  ...
  report?: 'overview' | 'executive-dashboard' | 'ro-billing-report' | 'workshop-performance' | 'workshop-summary' | 'open-ro' | 'platinum-complaints' | 'sot-analysis' | 'service-dashboard'
}
