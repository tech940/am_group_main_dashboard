...
export default function DiscountApprovalSubmitPage() {
  const [requesterName, setRequesterName] = useState('')
  const [branch, setBranch] = useState<'hyundai' | 'platinum'>('hyundai')
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 flex items-center justify-center p-4 sm:p-6 lg:p-8 font-sans selection:bg-teal-500 selection:text-white relative overflow-hidden">
      {/* Dynamic Background Gradients */}
      <div className="absolute top-[-20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-teal-600/5 blur-[120px]" />
      ...
      <div className="w-full max-w-2xl bg-white border border-slate-100/90 rounded-3xl p-6 sm:p-8 lg:p-10 shadow-[0_20px_50px_rgba(15,23,42,0.06)] relative z-10">
        ...
        <div className="space-y-3 text-center mb-8">
          <div className="inline-flex items-center px-3.5 py-1.5 rounded-full bg-teal-50 border border-teal-100 text-teal-600 text-xs font-black tracking-wide uppercase">
            <span>Discount Approval Portal</span>
          </div>
          <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">
            Hyundai & Platinum Discount Approval
          </h1>
        ...
        {submitStatus === 'success' ? (
          ...
          <div className="py-8 text-center space-y-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-teal-600 hover:bg-teal-700 text-white rounded-xl text-sm font-extrabold transition-all shadow-md shadow-teal-600/10 cursor-pointer"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* Branch Selector */}
            <div className="space-y-2">
              <label className="text-xs font-black uppercase tracking-wider text-slate-550 block">
                Select Branch <span className="text-rose-500">*</span>
              </label>
              <div className="grid grid-cols-2 gap-4">
                <button
                  type="button"
                  onClick={() => { setBranch('hyundai'); setVerifySuccess(null); }}
                  className={`flex flex-col items-center justify-center p-4 rounded-2xl border transition-all cursor-pointer ${
                    branch === 'hyundai'
                      ? 'bg-teal-50/50 border-teal-500 text-teal-700 font-extrabold'
                      : 'bg-slate-50/50 border-slate-200 text-slate-500 hover:bg-slate-50 font-bold'
                  }`}
                >
                  <Building2 className={`h-5 w-5 mb-2 ${branch === 'hyundai' ? 'text-teal-600' : 'text-slate-400'}`} />
                  <span className="text-xs uppercase tracking-wider">AM Hyundai</span>
                </button>
                <button
                  type="button"
                  onClick={() => { setBranch('platinum'); setVerifySuccess(null); }}
                  className={`flex flex-col items-center justify-center p-4 rounded-2xl border transition-all cursor-pointer ${
                    branch === 'platinum'
                      ? 'bg-teal-50/50 border-teal-500 text-teal-700 font-extrabold'
                      : 'bg-slate-50/50 border-slate-200 text-slate-500 hover:bg-slate-50 font-bold'
                ...
                >
                  <Gem className={`h-5 w-5 mb-2 ${branch === 'platinum' ? 'text-teal-600' : 'text-slate-400'}`} />
                  <span className="text-xs uppercase tracking-wider">AM Platinum</span>
                </button>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full h-11 bg-slate-50 border border-slate-200 focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500 rounded-xl pl-10 pr-10 text-sm text-slate-900 transition-all outline-hidden font-bold appearance-none cursor-pointer"
                >
              ...
              {selectedExecutive === 'Other' && (
                <div className="pt-2 animate-in fade-in slide-in-from-top-1 duration-150">
                  <input
                    ...
                    className="w-full h-11 bg-slate-50 border border-slate-200 focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500 rounded-xl px-4 text-sm text-slate-900 placeholder-slate-400 transition-all outline-hidden font-bold"
                  />
                </div>
              )}
            </div>

            {/* Customer ID Lookup Section */}
            <div className="space-y-2">
              ...
              <div className="flex gap-3">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full h-11 bg-slate-50 border border-slate-200 focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500 rounded-xl pl-10 pr-4 text-sm text-slate-900 placeholder-slate-400 transition-all outline-hidden font-bold"
                  />
                </div>
                <button
                  type="button"
            ...
            <div className="bg-slate-50/50 border border-slate-150 rounded-2xl p-4 sm:p-5 space-y-4">
              <div className="flex items-center justify-between border-b border-slate-150 pb-2">
                ...
                <span className="text-[9px] font-black text-teal-700 bg-teal-50 px-2 py-0.5 rounded-md">Live Lookup</span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-bold">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full h-8 bg-transparent border-b border-slate-200 focus:border-teal-500 text-slate-800 placeholder-slate-400 outline-hidden transition-all font-bold"
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full h-11 bg-slate-50 border border-slate-200 focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500 rounded-xl pl-9 pr-4 text-sm text-slate-900 placeholder-slate-400 transition-all outline-hidden font-bold"
                  />
                </div>
              </div>
            ...
            {/* TL / Manager, Date of Delivery, Reference */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full h-11 bg-slate-50 border border-slate-200 focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500 rounded-xl px-3.5 text-sm text-slate-900 transition-all outline-hidden font-bold appearance-none cursor-pointer pr-10"
                  >
                ...
                {selectedTL === 'Other' && (
                  <div className="pt-2 animate-in fade-in slide-in-from-top-1 duration-150">
                    <input
                      ...
                      className="w-full h-11 bg-slate-50 border border-slate-200 focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500 rounded-xl px-3.5 text-sm text-slate-900 placeholder-slate-400 transition-all outline-hidden font-bold"
                    />
                  </div>
                )}
              </div>
              ...
              {/* Date of Delivery */}
              <div className="space-y-2">
                <label htmlFor="deliveryDate" className="text-xs font-black uppercase tracking-wider text-slate-550 block">
                  Date of Delivery
                </label>
                <input
                  type="date"
                  ...
                  className="w-full h-11 bg-slate-50 border border-slate-200 focus:bg-white focus:border-teal-500 focus:ring-1 focus:ring-teal-500 rounded-xl px-3.5 text-sm text-slate-900 transition-all outline-hidden"
                />
              </div>
            ...
            <div className="space-y-4 pt-2">
              ...
              <button
                ...
                className="w-full h-12 bg-teal-600 hover:bg-teal-700 disabled:opacity-50 text-white rounded-xl text-sm font-black tracking-wide uppercase flex items-center justify-center gap-2 cursor-pointer shadow-md shadow-teal-600/10 active:scale-[0.99] transition-all"
              >
                {isSubmitting ? (
                  <>
