...
function SourceCoverageBadge({
  ...
  return (
    <div className={cn('rounded-2xl border p-4 shadow-sm transition-all hover:shadow-md hover:scale-[1.01]', styles[index % styles.length])}>
      <p className="text-[10px] font-bold uppercase tracking-wider opacity-75">{label}</p>
      <p className="mt-1 text-lg font-black">{formatNumber(rowCount)} rows</p>
      <p className="mt-1 text-[11px] font-medium opacity-80">Updated {formatDateTime(sourceUpdatedAt)}</p>
    </div>
  )
}
  ...
  return (
    <MainLayout title="Sales Report" subtitle="AM Kia sales analytics workspace">
      <div className="space-y-6 pb-4">
        ...
        <Card className="rounded-[2.25rem] border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between border-b border-slate-100 pb-5">
            <div>
              ...
              <h1 className="mt-2 text-3xl font-black tracking-tight text-slate-900">Sales Report</h1>
              <p className="mt-1 text-sm font-medium text-slate-500">
                Unified enquiry, booking, retail, and accessories analytics with live month coverage.
              </p>
            </div>

            {/* Controls (Soft grey contrast inside white card) */}
            <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-slate-200 bg-white p-2.5 shadow-sm">
              <div className="min-w-[140px]">
                <p className="mb-1 text-[9px] font-bold uppercase tracking-wider text-slate-400">Month</p>
                <Select value={selectedMonthOption?.key || ''} onValueChange={handleMonthChange}>
                  <SelectTrigger className="h-9 rounded-xl border-slate-200 bg-white text-xs text-slate-900 shadow-sm focus:ring-sky-500">
              ...
              <div className="min-w-[140px]">
                <p className="mb-1 text-[9px] font-bold uppercase tracking-wider text-slate-400">Dealer</p>
              ...
              <div className="flex flex-col justify-end pt-4">
                <Button type="button" className="h-9 rounded-xl border border-slate-200 bg-white px-4 text-xs font-bold text-slate-700 shadow-sm hover:bg-slate-50 hover:text-slate-900" onClick={() => {
          ...
          {(summary?.assumptions || []).length ? (
            <div className="rounded-2xl border border-slate-100 bg-slate-50/50 p-4 transition-all hover:bg-slate-50 mt-5">
              <details className="group">
                <summary className="flex cursor-pointer items-center justify-between text-xs font-bold uppercase tracking-wider text-slate-500 list-none select-none">
                  <div className="flex items-center gap-2">
                    <span className="flex h-5 w-5 items-center justify-center rounded-full bg-slate-200/50 text-[10px] text-slate-600">i</span>
                ...
                <div className="mt-3 grid gap-2.5 text-xs text-slate-600 border-t border-slate-200/50 pt-3">
            ...
            <ChartCard
              ...
              action={(
                <Select value={modelSourceFilter} onValueChange={setModelSourceFilter}>
                  <SelectTrigger className="w-[220px] rounded-2xl border-slate-200 bg-white shadow-sm">
              ...
              <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select value={String(reportPageSize)} onValueChange={(value) => {
                    ...
                    <SelectTrigger className="w-24 rounded-2xl border-slate-200 bg-white shadow-sm">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
