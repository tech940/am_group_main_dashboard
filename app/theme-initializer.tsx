...
const themeInitScript = `
  try {
    ...
    const storedAccent = window.localStorage.getItem('dashboard-accent') || 'midnight-lavender';
    const legacyAccents = ['navy', 'indigo', 'blue', 'violet', 'ruby', 'minimal-slate', 'minimal-sage', 'minimal-sand'];
    const accent = legacyAccents.includes(storedAccent) ? 'midnight-lavender' : storedAccent;
