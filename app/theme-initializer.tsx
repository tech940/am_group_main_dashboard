...
const themeInitScript = `
  try {
    ...
    const legacyAccents = ['navy', 'indigo', 'blue', 'violet', 'ruby', 'minimal-slate', 'minimal-sage', 'minimal-sand', 'midnight-lavender', 'skydash', 'corona', 'amethyst', 'tropical-teal', 'sunset-ember'];
