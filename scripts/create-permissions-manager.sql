...
values
  ...
  ('kia.service_appointment', 'Service Appointment', 'kia.service', 'AM KIA service appointment register and calendar.', 32),
  ...
  ('am_finance', 'AM Finance', null, 'Finance sheet register, payout status, bank performance analytics, and entry form.', 55),
...
with permission_seed(group_key, action, label, description, sort_order) as (
  values
    ...
    ('kia.service_appointment', 'view', 'Service Appointment: View', 'View access for Service Appointment.', 320),
    ...
    ('am_finance', 'view', 'AM Finance: View', 'View access for AM Finance.', 550),
    ('am_finance', 'create', 'AM Finance: Create', 'Create access for AM Finance.', 551),
    ('am_finance', 'edit', 'AM Finance: Edit', 'Edit access for AM Finance.', 552),
    ('am_finance', 'audit', 'AM Finance: Audit', 'Audit access for AM Finance.', 553),
