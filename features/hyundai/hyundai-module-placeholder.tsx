...
type HyundaiModulePlaceholderProps = {
  title: string
  eyebrow?: string
  description?: string
}

export function HyundaiModulePlaceholder({
  title,
  eyebrow = 'AM Hyundai',
  description = 'This section is ready in the sidebar. Data screens will be connected when AM Hyundai module work begins.',
}: HyundaiModulePlaceholderProps) {
  return (
    <MainLayout title="AM Hyundai" subtitle="Module setup">
