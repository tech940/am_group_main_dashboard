...
export function BusinessExcellenceOverview({ dateFilter, dealerCode }: { dateFilter: BusinessDateFilter; dealerCode?: string | null }) {
  ...
  const { data: summaryData, isLoading, error } = useQuery<OverviewData, Error>({
    ...
    queryFn: async () => {
      const response = await fetch(`/api/brands/hyundai/business-excellence/overview?${summaryQueryString}`)
  ...
  const { data: secondaryData } = useQuery<OverviewData, Error>({
    ...
    queryFn: async () => {
      const response = await fetch(`/api/brands/hyundai/business-excellence/overview?${secondaryQueryString}`)
  ...
  const { data: roAnalysisTableData, isLoading: isRoAnalysisTableLoading } = useQuery<ROAnalysisResponse, Error>({
    ...
    queryFn: async () => {
      const response = await fetch(`/api/brands/hyundai/business-excellence/ro-billing-analysis?${roAnalysisTableQueryString}`)
  ...
  const { data: roAnalysisTrendData, isLoading: isRoAnalysisTrendLoading } = useQuery<ROAnalysisResponse, Error>({
    ...
    queryFn: async () => {
      const response = await fetch(`/api/brands/hyundai/business-excellence/ro-billing-analysis?${roAnalysisTrendQueryString}`)
