    ...
    return (
      <div className="bg-slate-50 p-8">
        <div className="rounded-[1.5rem] border border-dashed border-slate-200 bg-white p-12 text-center shadow-xl shadow-slate-200/50">
          ...
          <p className="text-sm font-black uppercase tracking-widest text-slate-400">Platinum Complaints data is unavailable.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-5 bg-slate-50 p-4 lg:p-6">
      ...
      {showCalendarView && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-label="Platinum Complaints calendar"
        >
